...
def process_audio_files(audio_folder, model):
...
def main():
    ...
    with cProfile.Profile() as pr:
        ...
        parent_directory = "F:/1.Deakin university/Python/13_10_2023_My_Project_1/Deep-VR/deep-speaker/samples/LibriSpeech/dev-clean"  # Replace with the actual path

        # Iterate through subdirectories within the parent directory
        all_matrices = []
        for subdirectory in os.listdir(parent_directory):
            subdirectory_path = os.path.join(parent_directory, subdirectory)

            if os.path.isdir(subdirectory_path):
                matrices = process_audio_files(subdirectory_path, model)
...
if __name__ == "__main__":
    ...
    )  # Execution time: 129.51450490951538 seconds

# matrix_folder = "F:/1.Deakin university/Python/13_10_2023_My_Project_1/Deep-VR/deep-speaker/samples/LibriSpeech/dev-clean/all_matrices.npy"

# load_data = np.load(matrix_folder)

# # Print the contents of the file
# print(load_data[390][0:2])

# matrix_folder_2 = (
#     "F:/1.Deakin university/Python/13_10_2023_My_Project_1/all_matrices.npy"
# )

# load_data_2 = np.load(matrix_folder_2)

# # Print the contents of the file
# print(load_data_2[390][0:2])
