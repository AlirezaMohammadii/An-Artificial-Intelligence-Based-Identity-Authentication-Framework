...
train_df = pd.read_csv("../data/guardian/knn_model/6038796523-300-5.csv")
test_df = pd.read_csv("../data/guardian/knn_model/test_6038796523-300-5.csv")
...
param_grid = {
    ...
    "gamma": [1, 1.5],  # [1, 1.5, 2],
    "subsample": [0.8, 0.5, 1],  # [0.5, 0.8, 1.0],
    "colsample_bytree": [0.2, 0.5, 0.8],  # [0.6, 0.8, 1.0],
    "n_estimators": [100, 300],  # [100, 200, 300],
...
# # Load training dataset
# data = pd.read_csv("../data/guardian/knn_model/training_9050782635-200.csv")
# X = data.iloc[:, 1:]
# y = data.iloc[:, 0:1].values.ravel()

# # Load the test dataset
# test_data = pd.read_csv("../data/guardian/knn_model/test_9050782635-200.csv")
...
#     X_train, X_val = X.iloc[train_index], X.iloc[val_index]  # Corrected
