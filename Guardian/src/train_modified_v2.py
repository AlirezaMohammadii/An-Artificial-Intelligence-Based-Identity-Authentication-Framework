...
def balanced_batch_generator(X, y, batch_size=256):
    while True:
...
def main(model_ID, epochs, batch_size, n_splits, embedding_folder):
    ...
    # class_weight_dict = dict(enumerate(class_weights))  # "Auto [ 0.52609727 10.07954545]"
    # print("Automatically computed class weights:", class_weights)
    class_weight_dict = {0: 0.5, 1: 12}
...
if __name__ == "__main__":
    ...
    batch_size = 256
    n_splits = 5
    embedding_folder = "../data/sample_dataset/embedding_org"
    ###################################################### change detail here ################################################
