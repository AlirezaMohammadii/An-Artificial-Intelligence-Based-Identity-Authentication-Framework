...
if __name__ == "__main__":
    ensure_subdirectories_exist("../data/sample_dataset/transferability-50_50/")
    ###################################################### change detail here ################################################

    npy_dir = "../data/sample_dataset/transferability-50_50/npy/"
    out_dir = "../data/sample_dataset/transferability-50_50/embedding/"
