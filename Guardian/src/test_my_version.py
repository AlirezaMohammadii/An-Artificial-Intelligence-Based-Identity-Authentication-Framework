    ...
    for i in file_list:
        ...
        if "(" in i:
            for checkpoint_index in range(times):
                ...
                # print(f"raw result is: {raw_result}")
                ##########
                # 0.5/0.25
                total_raw_result += raw_result
                # print(f"total_raw_result is: {total_raw_result}")
...
if __name__ == "__main__":
    ...
    file_list = "../data/sample_dataset/transferability-50_50/npy_test/*"
